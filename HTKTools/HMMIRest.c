...
/*chaopig*/
/*printf("\nSTATUS: CorrIndex = %d, RecogIndex1 = %d, RecogIndex2 = %d, MPE = %d, ML_MODE = %d\n\n", CorrIndex, RecogIndex1, RecogIndex2, MPE, ML_MODE);*/
...
/*chaopig*/
/*printf("\nIN UpdateTrans: ML_MODE = %d, THREEACCS = %d\n\n", ML_MODE, THREEACCS);*/
...
/*chaopig*/
/*printf("UpdateTrans: ML_MODE = %d, THREEACCS = %d, ta1 = %p, ta1 = %p, ta3 = %p\n", ML_MODE, THREEACCS, ta1, ta2, ta3);*/
   N = hmm->numStates;
   for (i=1;i<N;i++) {
/*chaopig*/
/*printf("\tta1->occ[%d]=%e, ta2->occ[%d]=%e\n", i, ta1->occ[i], i, ta2->occ[i]);*/
