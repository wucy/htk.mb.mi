...
int GetMacroUse(MLink ml)
{
   ...
   case 'r':    
      use=-1; break;
   case 'n': /* cz277 - ANN */
      use = ((ADLink) (ml->structure))->nUse; break;
   case 'k':
      use = ((LELink) (ml->structure))->nUse; break;
   case 'e':
      use = ((FeaMix *) (ml->structure))->nUse; break;
   case 'o': /* fake */
   default:
      use=-1;
...
void SetMacroUse(MLink ml,int use)
{
   ...
   case 'r': 
      break;
   case 'n': /* cz277 - ANN */
      ((ADLink) (ml->structure))->nUse = use; break;
   case 'k':
      ((LELink) (ml->structure))->nUse = use; break;
   case 'e':
      ((FeaMix *) (ml->structure))->nUse = use; break;
   default:
