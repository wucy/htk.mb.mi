...
typedef struct _HMMSet{
   ...
   /*int nMacroNum;*/                      /* the number of ANN related Macros */
   /*MLink nMacroList[MAXANNITEMS];*/       /* the Macro list with ANN related stuffs (~e, ~k, ~n) */
   int eTypeMacNum;			/* number of e type macro */
   int kTypeMacNum;			/* number of k type macro */
   int nTypeMacNum;			/* number of n type macro */
